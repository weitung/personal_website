...
class WeitungPersonalPageStyle(Famcy.FamcyStyle):
	...
	def render(self, extra_script, content, background_flag=False, route="", time=5000, form_init_js=None, end_script="", **kwargs):
		...
		return render_template("portfolio.html", form_init_js=form_init_js, load_spinner=load_spinner, font_theme=font_theme, color_theme=color_theme, html_header=html_header, content=content, extra_script=extra_script, end_js=end_js, body_on_load=body_on_load)
